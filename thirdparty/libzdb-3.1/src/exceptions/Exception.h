 ...
 * CATCH(SQLException)
 * {
 * 	Assertion_assert(i == 1); // Unless declared volatile i would be 0 here (implementation dependent)
 * }
 * END_TRY;
 * Assertion_assert(i == 1); // i will be 1 here regardless if it is declared volatile or not 
 * </pre>
 * 
 * <h3>Thread-safe</h3>
 *
