...
void PreparedStatement_setString(T P, int parameterIndex, const char *x, size_t size) {
	Assertion_assert(P);
...
void PreparedStatement_setBlob(T P, int parameterIndex, const void *x, size_t size) {
	Assertion_assert(P);
