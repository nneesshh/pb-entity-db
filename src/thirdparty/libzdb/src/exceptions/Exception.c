...
static void close_once(void) {
	ThreadData_delete(Exception_stack);
}
...
void Exception_init(void) { pthread_once(&once_control1, init_once); }
void Exception_close(void) { pthread_once(&once_control2, close_once); }
